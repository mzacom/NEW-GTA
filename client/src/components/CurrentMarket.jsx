...
const CurrentMarket = () => {
  ...
  return (
    <div className={`md:mb-0 mb-5`}>
      <section
        id="features"
        className={`${styles.boxWidth} ${styles.paddingY} ${styles.padding} bg-white dark:bg-black font-poppins text-black dark:text-white mt-[-120px] md:mt-[-120px]`}
      >
        <div className={`md:mb-0 mb-5`}>
          ...
          <div className="  md:p-1 justify-center flex items-center ">
            <h6 className=" mt-3 text-center sm:text-[large] md:text-[large] text-slate-500">
              The forex market is a dynamic and fast-paced global marketplace
              where currencies are traded, influenced by various economic
          ...
          <div className="flex  flex-col  ">
            <div
              className={`${styles.padding} mt-[25px] roundedd w-[100%]  h-[100px] sm:h-[110px] gap- dark:bg-slate-900 bg-slate-300`}
            >
              <DigitalClock />
              ...
              <input
                ...
                value={searchTerm}
                onChange={onSearch}
                className=" p-4 pl-5 w-[80%] ml-[10%] md:ml-[80%] h-[30px] md:w-[20%] rounded-full outline-none dark:bg-slate-300 mt-2 text-black "
                placeholder="search"
              />
            </div>

            <div className="w-full text-white h-[40px] sm:h-[50px] md:h-[50px] flex justify-between items-center bg-blue-600">
              <div className="ml-[20%]">Qoutes</div>

              <div className=" mr-[20%]">Rates</div>
            </div>
            <div
              className={`w-full h-[250px] sm:h-[350px] list-none md:h-[400px]  dark:bg-slate-900 bg-slate-300 overflow-scroll ${styles.paddingX2} ${styles.paddingY} flex justify-center `}
            >
            ...
            <div className="w-[100%] h-[40px] dark:bg-slate-900 round  bg-slate-300"></div>
          </div>
        </div>
