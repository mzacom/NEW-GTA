...
const DashBoard = () => {
  return (
    <>
      ...
      {/*  Desktop Dashboard */}
      <section className=" hidden gap-8 sm:flex flex-col">
        {/* head */}
      ...
      <div className=" sm:hidden flex w-full ">
        <section className=" flex w-full mx-4 my-4  justify-between items-center   ">
          {/* search and profile */}
          {/* search */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <input
              ...
              name=""
              id=""
              className=" search-icon w-[150px] focus:border-blue-600 border-[1px] dark:border-slate-800 outline-none dark:bg-slate-800 bg-slate-300 rounded-lg p-1 pl-3 "
              placeholder="search "
            />
          </motion.div>
          ...
          <motion.div>
            ...
            <div className=" flex  items-center gap-2">
              ...
              {/* Username */}
              <p className=" bg-blue-500 text-[11px] text-white p-[5px] rounded-lg ">
                Lowkey1921
              </p>
            </div>
          </motion.div>
      ...
      {/* Grids */}
      <section className=" sm:hidden p-4 flex-col gap-5 flex w-full ">
         ...
         <motion.div
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className=" bg-blue-600 w-[100%]   h-[300px] shadow-lg  rounded-3xl "
          ></motion.div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.5 }}
              className=" w-full h-[130px] shadow-lg bg-pink-400 rounded-3xl "
            ></motion.div>
